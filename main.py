...
if __name__ == "__main__":
    ...
    SUFFIX_TEXTURE_LAW = "_law"
    K = 6
    MAX_NUM_ITERATION = 20
    MAP_FEATURES = law_texture_energy.extract_law_texture_features(PATH_FOLDER + NAME_IMG+FILE_EXTENSION_OCT)
    kmeans_clustering.cluster_output_image_label(NAME_IMG+SUFFIX_TEXTURE_LAW, MAP_FEATURES, K, MAX_NUM_ITERATION)
